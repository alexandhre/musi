...
Vue.component('modaldetalhe', require('./components/modal/ModalDetalhe.vue'));
...
Vue.component('opcoes', require('./components/Opcoes.vue'));
Vue.component('formregister', require('./components/FormRegister.vue'));
